    ...
    stage('Upload to www'){
      sh '''#!/bin/bash
        if [ $OTA = 'true' ]; then
          ...
          python /home/www/gen_mirror_json.py /home/www/nginx/sites/harryyoud.co.uk/public_html/builds/ > /home/www/nginx/sites/harryyoud.co.uk/public_html/builds.json
        else
