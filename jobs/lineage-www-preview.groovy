node("built-in"){
	...
	stage('Go'){
		sh '''#!/bin/bash
			...
			curl https://gist.githubusercontent.com/harryyoud/0977f6064d9c98ecab572e2b3c195f79/raw/ec9fa3290b3f7d1b1b55e366bc49b516341b5854/gistfile1.txt > Dockerfile
			echo >> _config.yml
			...
			mkdir -p /var/www/lineage.youd.dev/public/${PRIVATE}${CHANGE}/${PATCHSET}
			rsync -rh _site/ /var/www/lineage.youd.dev/public/${PRIVATE}${CHANGE}/${PATCHSET} --delete --exclude .well-known
		'''
	}
	stage('Reset'){
		sh '''
